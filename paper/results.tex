...
The second column counts how many lesions of that size the 70 test patients contain in total.
The last three give the share of them the detector could no longer find in each image.

\begin{center}\small
\renewcommand{\arraystretch}{1.15}
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{Lesion size} & \textbf{Lesions of this size} & \textbf{Low-resolution} & \textbf{Baseline} & \textbf{Ours} \\
\midrule
