...
After standard super-resolution (baseline)              & 54.6\% \\
\textbf{After tumor-aware super-resolution (ours)}      & \textbf{48.1\%} \\
\bottomrule
\end{tabular}
\end{center}
...
None of these figures should be read as ``half the tumors disappear'', because the detector
itself is responsible for most of them. Handed the untouched original scan, it already misses
\textbf{45.5\%} --- that is the floor. Measured against it, standard super-resolution adds 9.1
points of missed tumor and ours adds 2.6, so \textbf{our objective removes 71\% of the erasure
super-resolution actually causes}.
